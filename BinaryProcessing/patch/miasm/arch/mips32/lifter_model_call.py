...
class LifterModelCallMips32l(Lifter_Mips32l, LifterModelCall):
    ...
    def call_effects_systemV(self, ad, instr):
        call_assignblk = AssignBlock(
            [
                ExprAssign(ExprId('dummy1', 32), ExprOp('call_func_arg1', ad, self.arch.regs.A0)),
                ExprAssign(ExprId('dummy2', 32), ExprOp('call_func_arg2', ad, self.arch.regs.A1)),
                ExprAssign(ExprId('dummy3', 32), ExprOp('call_func_arg3', ad, self.arch.regs.A2)),
                ExprAssign(ExprId('dummy4', 32), ExprOp('call_func_arg4', ad, self.arch.regs.A3)),
